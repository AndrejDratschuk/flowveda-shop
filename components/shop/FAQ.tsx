...
const faqs = [
  {
    ...
    a: "Most people begin to feel a difference within the first 2–3 weeks. The mechanism compounds — by day 30 the calmer baseline is more stable, and by day 60 it's foundational. That's why we built the protocol around 60 days, and why we back it with a 60-day money-back guarantee.",
  },
  {
